...
def run():
    ...
    parser.add_argument("-m", "--mode", choices=["comment", "release"], default="comment", help="Execution mode")
    parser.add_argument("-r", "--repository", default=os.getenv('GITHUB_REPOSITORY', "mrachuta/nodejs-colorizedapp"), help="GitHub Repository")
    ...
    if args.mode == "comment":
        ...
        if pr.release_eligible and pr.is_merged:
            ...
            release.create_release(tag_name=release.new_tag, commit_sha=pr.merge_commit_sha)
